...
describe('Entity Unit Tests', () => {
  describe('Candidate Entity', () => {
    it('should create a candidate with valid data', async () => {
      ...
      expect(saved.skills).toEqual(['JavaScript', 'TypeScript', 'Node.js']);
  ...
  describe('JobPosting Entity', () => {
    ...
    it('should validate enum values for status', async () => {
      ...
      const validStatuses = [JobPostingStatus.OPEN, JobPostingStatus.CLOSED, JobPostingStatus.DRAFT];
  ...
  describe('Application Entity', () => {
    it('should create an application with relationships', async () => {
      ...
      const candidate = await candidateRepo.save(candidateRepo.create({
        firstName: 'Alice',
        lastName: 'Williams',
      ...
      const jobPosting = await jobPostingRepo.save(jobPostingRepo.create({
      ...
      expect(saved.aiSummary).toBe('Strong candidate with relevant experience');
    });
  ...
  describe('Interview Entity', () => {
    it('should create an interview with valid data', async () => {
      ...
      expect(saved.notes).toBe('Technical interview with senior engineer');
    ...
    it('should validate interview type enum', async () => {
      ...
      const types = [InterviewType.SCREENING, InterviewType.TECHNICAL, InterviewType.FINAL];
  ...
  describe('Offer Entity', () => {
    it('should create an offer with valid data', async () => {
      ...
      expect(saved.benefits).toBe('Health insurance, 401k, unlimited PTO');
  ...
  describe('Onboarding Entity', () => {
    it('should create an onboarding with JSONB tasks', async () => {
      ...
      const tasks = {
        'setup-workstation': { completed: false, dueDate: '2025-01-20' },
        'complete-paperwork': { completed: false, dueDate: '2025-01-18' },
        'attend-orientation': { completed: false, dueDate: '2025-01-22' }
      };
  ...
  describe('TalentPool Entity', () => {
    it('should create a talent pool with valid data', async () => {
      ...
      expect(saved.description).toBe('Experienced Java developers for future projects');
    });
  ...
  describe('Requisition Entity', () => {
    it('should create a requisition with valid data', async () => {
      ...
      const requisition = requisitionRepo.create({
        ...
        justification: 'Need to expand analytics team to handle increased data volume',
      ...
      expect(saved.justification).toBe('Need to expand analytics team to handle increased data volume');
    ...
    it('should load jobPosting relationship', async () => {
      ...
      const requisition = await requisitionRepo.save(requisitionRepo.create({
        requestedBy: 'Test Manager',
        justification: 'Test',
        status: RequisitionStatus.PENDING,
        jobPosting
